...
import { User, Phone, MessageSquare, Mail, CreditCard, Lock, ArrowRight, AlertCircle } from 'lucide-react'
    ...
    <div className="max-w-md mx-auto py-12 px-4">
      <div className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 shadow-sm space-y-6">
        <div className="text-center space-y-2">
          <h1 className="text-2xl font-black text-slate-900">Create Trendmark Account</h1>
          <p className="text-xs text-slate-500">
            Enter your correct M-Pesa & WhatsApp details to enable automated payout matching.
          </p>
        </div>
